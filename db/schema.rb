...
ActiveRecord::Schema.define(version: 20180105014040) do
  ...
  create_table "session_token_joins", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "session_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["session_id"], name: "index_session_token_joins_on_session_id", unique: true
    t.index ["user_id"], name: "index_session_token_joins_on_user_id"
  end
